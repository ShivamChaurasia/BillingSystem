...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BillingSystem = __webpack_require__(/*! ./BillingSystem.jsx */ 159);
	
	var _BillingSystem2 = _interopRequireDefault(_BillingSystem);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_BillingSystem2.default, null)
	      );
	    }
	  }]);
...
/* 159 */
/*!******************************************!*\
  !*** ./src/client/app/BillingSystem.jsx ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _underscore = __webpack_require__(/*! underscore */ 160);
	
	var _underscore2 = _interopRequireDefault(_underscore);
	
	var _DiscountSelector = __webpack_require__(/*! ./DiscountSelector.jsx */ 164);
	
	var _DiscountSelector2 = _interopRequireDefault(_DiscountSelector);
	
	var _FormComponent = __webpack_require__(/*! ./FormComponent.jsx */ 162);
	
	var _FormComponent2 = _interopRequireDefault(_FormComponent);
	
	var _TableComponent = __webpack_require__(/*! ./TableComponent.jsx */ 161);
	
	var _TableComponent2 = _interopRequireDefault(_TableComponent);
	
	var _TotalRow = __webpack_require__(/*! ./TotalRow.jsx */ 163);
	...
	var BillingSystem = function (_React$Component) {
	    _inherits(BillingSystem, _React$Component);
	
	    function BillingSystem(props) {
	        _classCallCheck(this, BillingSystem);
	
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BillingSystem).call(this, props));
	        ...
	        _this.removeObject = _this.removeObject.bind(_this);
	        _this.discountChange = _this.discountChange.bind(_this);
	        return _this;
	    }
	
	    _createClass(BillingSystem, [{
	        key: 'addObject',
	        ...
	        value: function removeObject(obj) {
	            this.setState({
	                items: _underscore2.default.without(this.state.items, obj)
	            });
	        }
	    }, {
	        key: 'discountChange',
	        value: function discountChange(val) {
	            this.setState({
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_DiscountSelector2.default, { discountSelected: this.state.discountSelected, discountChange: this.discountChange }),
	                _react2.default.createElement(_FormComponent2.default, { addObject: this.addObject }),
	                this.state.items.length > 0 ? _react2.default.createElement(_TableComponent2.default, { data: this.state.items, headers: this.state.headers, removeObject: this.removeObject }) : _react2.default.createElement(
	                    'div',
	                    { className: 'noDataClass' },
	                    'No Item Selected'
	                ),
	                this.state.items.length > 0 ? _react2.default.createElement(_TotalRow2.default, { data: this.state.items, discountSelected: this.state.discountSelected }) : null
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TableComponent = function (_React$Component) {
	    ...
	    function TableComponent(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TableComponent).call(this, props));
	    }
	    ...
	    _createClass(TableComponent, [{
	        ...
	        value: function render() {
	            var self = this,
	                ...
	                return _react2.default.createElement(
	                    ...
	                    self.props.headers.map(function (d, i) {
	                        if (d === "Remove") {
	                            return _react2.default.createElement(
	                                "td",
	                                { className: "removeIcon", key: value[d] + i, onClick: self.props.removeObject.bind(this, value) },
	                                _react2.default.createElement("img", { className: "deleteIcon", src: "./img/delete.ico" })
	                            );
	                        } else {
	                            return _react2.default.createElement(
	                                "td",
	                ...
	                return _react2.default.createElement(
	                    "th",
	                    { key: self.props.headers[i] },
	                    self.props.headers[i]
	                );
	            });
...
/* 162 */
/*!******************************************!*\
  !*** ./src/client/app/FormComponent.jsx ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var FormComponent = function (_React$Component) {
	    ...
	    function FormComponent(props) {
	        ...
	        _this.makeObject = _this.makeObject.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(FormComponent, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "label",
	                    { className: "formLabel", htmlFor: "itemId" },
	                    "Item ID"
	                ),
	                _react2.default.createElement("input", { id: "itemId", type: "text" }),
	                _react2.default.createElement(
	                    "label",
	                    { className: "formLabel", htmlFor: "name" },
	                    "Name"
	                ),
	                _react2.default.createElement("input", { id: "name", type: "text" }),
	                _react2.default.createElement(
	                    "label",
	                    { className: "formLabel", htmlFor: "cost" },
	                    "MRP ($)"
	                ),
	                _react2.default.createElement("input", { id: "cost", type: "text" }),
	                _react2.default.createElement(
	                    "label",
	                    { className: "formLabel", htmlFor: "quantity" },
	                    "Quantity"
	                ),
	                _react2.default.createElement("input", { id: "quantity", type: "text" }),
	                _react2.default.createElement("input", { className: "addButton", type: "button", value: "Add Item", onClick: this.makeObject })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Constants = __webpack_require__(/*! ../Constants.js */ 165);
	...
	var TotalRow = function (_React$Component) {
	    ...
	    function TotalRow(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TotalRow).call(this, props));
	    ...
	    _createClass(TotalRow, [{
	        ...
	        value: function getTotal() {
	            var total = _underscore2.default.reduce(_underscore2.default.map(this.props.data, function (value) {
	        ...
	        value: function getDiscount() {
	            return (this.state.total * _Constants2.default.discountRates[this.props.discountSelected] / 100).toFixed(2);
	        }
	    }, {
	        key: 'getTotalAfterDiscount',
	        value: function getTotalAfterDiscount() {
	            return (this.state.total * (100 - _Constants2.default.discountRates[this.props.discountSelected]) / 100).toFixed(2);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'section',
	                { className: 'totalContainer wbkitFlex' },
	                _react2.default.createElement('div', { className: 'helpContainer displaywidth1' }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'amountContainer displaywidth4' },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'calculationContainer' },
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'wbkitFlex' },
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'displaywidth2' },
	                                _react2.default.createElement(
	                                    'span',
	                            ...
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'displaywidth1 value' },
	                                _react2.default.createElement(
	                                    'span',
	                                    { className: 'headerText price' },
	                                    _react2.default.createElement(
	                                        'sup',
	                                        null,
	                                        '$'
...
/* 164 */
/*!*********************************************!*\
  !*** ./src/client/app/DiscountSelector.jsx ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var DiscountSelector = function (_React$Component) {
	    _inherits(DiscountSelector, _React$Component);
	
	    function DiscountSelector(props) {
	        _classCallCheck(this, DiscountSelector);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(DiscountSelector).call(this, props));
	    }
	
	    _createClass(DiscountSelector, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'form',
	                ...
	                _react2.default.createElement('input', { id: 'none', type: 'radio', name: 'discount', value: 'none', checked: this.props.discountSelected === "none", onChange: this.props.discountChange.bind(this, "none") }),
	                _react2.default.createElement(
	                    'label',
	                    { htmlFor: 'none' },
	                    'None'
	                ),
	                _react2.default.createElement('input', { id: 'employee', type: 'radio', name: 'discount', value: 'employee', onChange: this.props.discountChange.bind(this, "employee") }),
	                _react2.default.createElement(
	                    'label',
	                    { htmlFor: 'employee' },
	                    'Employee'
	                ),
	                _react2.default.createElement('input', { id: 'affiliate', type: 'radio', name: 'discount', value: 'affiliate', onChange: this.props.discountChange.bind(this, "affiliate") }),
	                _react2.default.createElement(
	                    'label',
	                    { htmlFor: 'affiliate' },
	                    'Affiliate'
	...
	exports.default = DiscountSelector;
